...
<div class="my-8 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
	<div class="rounded-xl border border-slate-200 bg-white p-6 text-center shadow-sm dark:border-slate-600 dark:bg-slate-800">
		...
		<div class="text-xs font-medium text-emerald-600">✓ Under 1.2s target</div>
	</div>
	<div class="rounded-xl border border-slate-200 bg-white p-6 text-center shadow-sm dark:border-slate-600 dark:bg-slate-800">
		...
		<div class="text-xs font-medium text-emerald-600">✓ Under 2.5s target</div>
	</div>
	<div class="rounded-xl border border-slate-200 bg-white p-6 text-center shadow-sm dark:border-slate-600 dark:bg-slate-800">
		...
		<div class="text-xs font-medium text-emerald-600">✓ Under 0.1 target</div>
	</div>
	<div class="rounded-xl border border-slate-200 bg-white p-6 text-center shadow-sm dark:border-slate-600 dark:bg-slate-800">
		...
		<div class="text-xs font-medium text-emerald-600">✓ Under 3.0s target</div>
	</div>
</div>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-8 my-8">
	<div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6">
		<h4 class="flex items-center gap-2 text-emerald-600 text-lg font-semibold mb-4 mt-0">✅ What AI Excels At</h4>
		<ul class="space-y-3 list-none p-0 m-0">
			<li class="relative pl-4">
				<span class="absolute left-0 text-gray-400">•</span>
    ...
    <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6">
    	<h4 class="flex items-center gap-2 text-amber-600 text-lg font-semibold mb-4 mt-0">⚠️ What AI Struggles With</h4>
    	<ul class="space-y-3 list-none p-0 m-0">
    		<li class="relative pl-4">
    			<span class="absolute left-0 text-gray-400">•</span>
