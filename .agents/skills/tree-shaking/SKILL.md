...
- Use ECMAScript 2015 `import`/`export` syntax — only ES modules can be tree-shaken
...
Only modules defined with the ECMAScript 2015 module syntax (`import` and `export`) can be tree-shaken. The way you import modules specifies whether the module can be tree-shaken or not.
