...
**Next.js Implementation:** Next.js allows us to create **route handlers** as serverless functions. We can define an API route that the React frontend will call for AI responses:
...
app.listen(6000, () =>
	console.log('API server listening on http://localhost:6000'),
)
```
...
- **User feedback:** Always inform the user when something goes wrong. Display the error inline in the chat – e.g., as a special "system" message saying "_Sorry, something went wrong. Please try again._"
