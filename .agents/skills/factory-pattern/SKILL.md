...
- Prefer ECMAScript 2015 arrow functions for concise factory function definitions
...
In JavaScript, the factory pattern isn't much more than a function that returns an object without using the `new` keyword. ECMAScript 2015 arrow functions allow us to create small factory functions that implicitly return an object each time.
